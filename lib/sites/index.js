...
module.exports = function(app, passport) {
    ...
    app.post('/site', isAuthenticated, function (req, res) {
        ...
        var site = new Site({title: req.body.site_title, content: req.body.site_content, user:req.user._id, date_created: date_created, theme: theme})
        site.save()
    ...
    app.post('/site/:id',isAuthenticated,  function (req, res) {
        var theme = req.body.theme || "simple"
        var site = {title: req.body.site_title, content: req.body.site_content, user:req.user._id, theme: theme}
    ...
    app.get('/view/:id', function (req, res) {
        Site.findOne({_id:req.params.id}, function(err, site) {
            ...
            res.render("base", {"content":divs, "id":req.params.id, "theme":site.theme})
        })
    })
