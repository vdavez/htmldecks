...
module.exports = function(app, passport) {
    ...
    app.post('/site', isAuthenticated, function (req, res) {
        ...
        var site = new Site({title: req.body.site_title, content: req.body.site_content, user:req.user._id, date_created: date_created})
        site.save()
    ...
    app.get('/view/:id', function (req, res) {
        Site.findOne({_id:req.params.id}, function(err, site) {
            ...
            res.render("base", {"content":divs, "id":req.params.id})
        })
    })
    ...
    app.get('/', function (req, res) {
        if (req.user) {res.redirect('/home')}
            ...
            res.render("home", {"content":divs, "title": "Welcome to HTML Decks"})
        })
}